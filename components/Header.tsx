...
export function Header() {
  return (
    <>
      {/* Top WhatsApp strip — text visually centered on the page (full-width navy bar,
          inner content centered via mx-auto max-w-7xl + text-center). */}
      <div className="w-full bg-brand-navy text-white text-xs md:text-sm py-2 px-4 md:px-10">
