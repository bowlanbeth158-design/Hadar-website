...
Dans le cadre de l'utilisation de la plateforme HADAR, certaines données personnelles peuvent être collectées.

Ces données sont fournies directement par l'utilisateur ou collectées automatiquement lors de la navigation.
